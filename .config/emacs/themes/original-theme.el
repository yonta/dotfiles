...
(let* ((dark1 "#1a1a1a")  ; 0, 0, 10 gray10
  ...
  (custom-theme-set-faces
   'original
   `(default ((t (:foreground ,dark1 :background ,light1))))
   ...
   `(rainbow-delimiters-base-error-face ((t (:background ,red2))))
   `(rainbow-delimiters-depth-1-face ((t (:foreground ,dark2))))
   `(rainbow-delimiters-depth-2-face ((t (:foreground ,dark-blue))))
   ...
   `(rainbow-delimiters-depth-6-face ((t (:foreground ,dark-purple))))
   `(rainbow-delimiters-depth-7-face ((t (:foreground ,dark-yellow))))
   `(rainbow-delimiters-depth-8-face ((t (:foreground ,dark2))))
