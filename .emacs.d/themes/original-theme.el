...
(custom-theme-set-faces
 'original
 '(default ((t (:family "VL ゴシック" :foundry "VL  " :width normal :height 121 :weight normal :slant normal :underline nil :overline nil :strike-through nil :box nil :inverse-video nil :foreground "#1A1A1A" :background "#F4F4F4" :stipple nil :inherit nil))))
 ...
 '(mode-line ((t (:box (:line-width -1 :color nil :style released-button) :foreground "black" :background "light sky blue"))))
 ...
 '(ahs-plugin-whole-buffer-face ((t (:background "light sky blue" :foreground "black"))))
